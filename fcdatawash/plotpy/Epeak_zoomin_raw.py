def selection_0():
    ...
    pad.text(73.6,1.5e4,r'Raw Data',fontsize=29)
    pad.text(73.255,0.8e4,r'$m_\chi = 74.9$ GeV',fontsize=22)

    pad.text(72.0,1.6e4,r'$m_\chi = 75$ GeV',color='red',fontsize=22)
    pad.text(73.9,1.0e3,r'$m_\chi = 50$ GeV',color="#5954d8",fontsize=22)
    ...
    plt.savefig('../figformal/peakzoomin_raw.png',format = 'png')
    plt.show()
