...
o = np.load('../plotCSV/sbdotsoptimised1.npy')
...
ax.text(1,0.1,r'Optimisation of cut',fontsize=25)
ax.legend((tl,ol),(r'Original cut',r'Optimised cut'),loc='upper left',fontsize = 25)
