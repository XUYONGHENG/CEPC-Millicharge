...
ax.text(1,1600,r'Higgs Factory, $\sqrt{s}$=240Gev',fontsize=20,color='black')
ax.text(1,800,r'W+W-, $\sqrt{s}$=160Gev',fontsize=20,color='red')
ax.text(1,1200,r'Z-pole, $\sqrt{s}$=91.2Gev',fontsize=20,color='blue')
ax.text(5,1450,'Scalar(s)',fontsize=24)
