...
a = np.load('../plotformalCSV/cepcz4f/sbdotscepcz4fav.npy')
b = np.load('../plotformalCSV/cepcz4f/sbdotscepcz4fss.npy')
c = np.load('../plotformalCSV/cepcz4f/sbdotscepcz4fst.npy')
d = np.load('../plotformalCSV/cepcz4f/sbdotscepcz4fvv.npy')
print(a.shape)
# print(b.shape)
