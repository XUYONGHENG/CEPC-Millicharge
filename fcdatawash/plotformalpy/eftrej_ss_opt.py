...
ax.text(2,1300,r'Higgs Factory $\sqrt{s}$=240Gev',fontsize=20,color='black')
ax.text(2,800,r'$W^+W^-$ $\sqrt{s}$=160Gev',fontsize=20,color='red')
ax.text(2,1150,r'$Z$-pole $\sqrt{s}$=91.2Gev',fontsize=20,color='blue')
ax.text(5,680,'Scalar(s)',fontsize=24)



plt.savefig('../figformal/eftrej_ss_opt.pdf')
