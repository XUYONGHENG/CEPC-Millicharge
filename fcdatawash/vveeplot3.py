...
a = np.load('/home/xyh/feynarts/workspace2/eevvA-SM5.fortran/result.npy')
b = np.load('/home/xyh/feynarts/workspace2/eevmvmA-SM4.fortran/result.npy')
c = np.load('/home/xyh/feynarts/workspace2/eeeeA-SM10.fortran/resultx'
            '.npy')
...
#     if int(str(c[i][1])[0]) >2 and int(str(c[i+1][1])[0])<2:
#         print(i)

# a[:9,1] = 0.01*a[:9,1]
# a[9:24,1] = 0.1*a[9:24,1]
# print(a[:5])
# a[0,1] = 0.01*a[0,1]
# a[1:3,1] = 0.1 * a[1:3,1]
# print(a[:5])
...
ax.plot(a[:,0],np.log10(a[:,1]),color = 'red',linestyle = '-')
...
ax.plot(c[:,0],np.log10(c[:,1]),c='black',linestyle = '--',label = 'Mann et al. 1987')
