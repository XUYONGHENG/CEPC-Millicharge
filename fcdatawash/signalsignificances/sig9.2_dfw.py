...
if __name__ == '__main__':
    ...
    for i in range(20):
        ...
        dots[i,1:] = signal_significance_ilc1211(s=data,
                            bg=bg,mass=masses[i],cut=cut.cut_cepc_darkphoton_w,dataamount=2.6e6,splusb=False)

        dots[i,0] = masses[i]
        print(dots[i])

    np.save('../plotformalCSV/cepcdarkphoton/sbdotscepcdfw.npy', dots)
    # tmp = []
