...
eftexclusion_h = np.load('../../plotCSV/eft_st_h_formal_1-100.npy')
eftexclusion_w = np.load('../../plotCSV/eft_st_w_formal_1-63.npy')
eftexclusion_z = np.load('../../plotCSV/eft_st_z_formal_1-39.npy')
...
ax.text(1.2,1000,r'H-mode $\sqrt{s}$=240 GeV',fontsize=20,color='black',fontfamily='serif')
ax.text(1.2,650,r'WW-mode $\sqrt{s}$=160 GeV',fontsize=20,color='red',fontfamily='serif')
ax.text(1.2,750,r'Z-mode $\sqrt{s}$=91.2 GeV',fontsize=20,color='blue',fontfamily='serif')
ax.text(3,400,'Scalar(t)',fontsize=24,fontfamily='serif')
...
plt.savefig('/home/xyh/texworkbench/cepc/paperdraft/figs/eftrej_st_3.pdf',format='pdf')
