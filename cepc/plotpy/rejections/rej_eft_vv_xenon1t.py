...
xtc,xtcm = np.array(pd.read_csv("/home/xyh/PycharmProjects/cepc/plotCSV/xtlimitsi.csv",header=None)),\
np.array(pd.read_csv("/home/xyh/PycharmProjects/cepc/plotCSV/xtlimitsi_m.csv",header=None))
######
...
ax.text(10,2000,r'CEPC limit on Vector EFT',fontsize=18,fontfamily='serif')
ax.text(30,20000,r'XENON1T',fontsize=18,fontfamily='serif',color='green')
...
ax.legend((lh,lw,lz),('H-mode','W-mode','Z-mode'),loc='upper left',fontsize=20,framealpha=0)
plt.savefig('/home/xyh/texworkbench/cepc/paperdraft/figs/eftrej_vv_withxenon1t.pdf',format='pdf')
