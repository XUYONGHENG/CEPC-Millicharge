...
eftexclusion_h = np.load('../../plotCSV/eft_ss_h_formal_1-100.npy')
eftexclusion_w = np.load('../../plotCSV/eft_ss_w_formal_1-63.npy')
eftexclusion_z = np.load('../../plotCSV/eft_ss_z_formal_1-39.npy')
...
lw, = ax.plot(eftexclusion_w[:,0],eftexclusion_w[:,1],color='red',linestyle='--',linewidth=3)
...
ax.text(1.4,1320,r'H-mode $\sqrt{s}$=240 GeV',fontsize=20,color='black',fontfamily='serif')
ax.text(1.4,850,r'WW-mode $\sqrt{s}$=160 GeV',fontsize=20,color='red',fontfamily='serif')
ax.text(1.4,1120,r'Z-mode $\sqrt{s}$=91.2 GeV',fontsize=20,color='blue',fontfamily='serif')
ax.text(5,400,'Scalar(s)',fontsize=24,fontfamily='serif')
...
# plt.savefig('/home/xyh/Desktop/test.png',format='png')
plt.savefig('/home/xyh/texworkbench/cepc/paperdraft/figs/eftrej_ss_3.pdf',format='pdf')
plt.show()